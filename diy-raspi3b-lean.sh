...
#echo '修改feeds'
#sed -i '1,2s/coolsnowwolf/catwarrior/g' ./feeds.conf.default
...
date=`date +%m.%d.%Y`
sed -i "s/SyPopo$/Catwarrior $date/g" package/base-files/files/etc/banner
...
echo "DISTRIB_REVISION='Compiled by Catwarrior'" >> /etc/openwrt_release
